...
def parse_args():
    parser = argparse.ArgumentParser(description="Analyze subject-level RDMs.")
    parser.add_argument('--rdm_dir', type=str, required=True, 
                        help='Directory containing the RDM files')
    parser.add_argument('--subject_n', type=int, default=1, 
                        help='Subject number to analyze (default: 1)')
